...
def lihat_riwayat():
    ...
    if not riwayat_pengembalian:
        ...
        for r in riwayat_pengembalian:
            print("{:<20} {:<20} {:<20}".format("Judul Buku", "Nama Peminjam", "Tanggal Kembali"))
        print("-" * 60)
        for record in riwayat_pengembalian:  # Assuming riwayat_pengembalian is your list of return records
            print("{:<20} {:<20} {:<20}".format(record['judul_buku'], record['nama_peminjam'], record['tanggal_kembali']))
        print()

def lihat_riwayat_tabel():
    print("{:<20} {:<20} {:<20}".format("Judul Buku", "Nama Peminjam", "Tanggal Kembali"))
    print("-" * 60)
    for record in riwayat_pengembalian:  # Assuming riwayat_pengembalian is your list of return records
        print("{:<20} {:<20} {:<20}".format(record['judul_buku'], record['nama_peminjam'], record['tanggal_kembali']))
